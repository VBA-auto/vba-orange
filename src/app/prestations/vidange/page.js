  ...
  return (
    <section className="px-5 md:px-0">
      <Head>
        ...
        <meta
          name="description"
          content="Nous réalisons l'entretien et la vidange complète des boites de vitesse automatique avec joint de carter crépine et cartouche externe avec l'huile homologuée constructeur"
        />
        <meta
          name="title"
      ...
      <div id="main" className="container mx-auto">
        <div className="flex gap-14 items-stretch flex-col-reverse md:flex-row">
          <div className="md:w-1/2">
            ...
            <p className="text-justify mb-2 paragraph">
              Certaines boites de vitesses automatiques sont à convertisseur de
              ...
              d&apos;huile varie selon les boites: les doubles embrayages à sec
              nécessitent peu d&apos;huile, tandis que les autres types
              contiennent généralement entre <b>7 et 10 litres</b>.
            </p>
            <p className="text-justify mb-2 paragraph">
              Il est donc important de lubrifier correctement sa boite de
              vitesse automatique. Une vidange est recommandée tous les{" "}
              <b>60 000 à 80 000 km</b>.
            </p>
            <p className="text-justify mb-2 paragraph">
        ...
        <div className="md:flex gap-14">
          <div className="md:w-3/4">
            ...
            <p className="text-justify mb-2 paragraph">
              Lorsqu&apos;il s&apos;agit de vidanger votre boite de vitesses
              ...
              de remplacer jusqu&apos;à <b>95-100%</b> de l&apos;huile,
              contrairement à la méthode par gravité qui ne renouvelle
              qu&apos;environ 70% de l&apos;huile (50% sur modèle Jatco par
              exemple)
            </p>
            <p className="text-justify mb-2 paragraph">
              ...
              boite&apos; élimine aussi la poussière de métal créée par
              l&apos;usure des pièces.
            </p>
            <p className="text-justify mb-2 paragraph">
              Il suffit de remplir le réservoir d&apos;huile neuve de la
              machine, de connecter les tuyaux aux raccords du radiateur de la
              boite de vitesses et de lancer le programme. La machine ajuste
              automatiquement le niveau d&apos;huile. Il est important de noter
              que pour une boite de vitesses automatique (BVA) d&apos;une
              capacité totale de <b>8 litres</b>, il faut souvent injecter bien
              plus de
              <b> 8 litres</b> d&apos;huile neuve pour atteindre un résultat
            ...
            <p className="text-justify mb-2 paragraph">
              ...
              entretien optimal de votre boite de vitesses automatique, surtout
              pour les modèles sans carter comme{" "}
              <b>
                Audi A4/A5/A6/A7/A8, Peugeot 508, Citroën, Opel, Renault, Volvo,
                Mini
              </b>
              .
            </p>
        ...
        <div className=" pb-16">
          ...
          <p className="text-justify mb-2 paragraph">
            Pour garantir les performances de votre boite de vitesses
            automatique, il est essentiel de choisir la bonne huile. Les
            mécanismes des boites automatiques doivent être lubrifiés
            efficacement. Contrairement aux boites manuelles qui utilisent de
            l&apos;huile minérale, les boites automatiques utilisent des huiles
          ...
          <p className="text-justify mb-2 paragraph">
            ...
            spécifique aux boites modernes pour une meilleure fluidité à basse
          ...
          <p className="text-justify mb-2 paragraph">
            ...
            de vidange par flushing, utilisant une machine spécifique, garantit
            un remplacement quasi complet de l&apos;huile, assurant ainsi des
