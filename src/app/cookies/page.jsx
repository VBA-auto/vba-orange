      ...
      <div className="container max-w-screen-xl mx-auto">
        ...
        <div className="mb-5">
          ...
          <p className="text-[#424242] mt-2">
            ...
            cookies sont déposés sur votre navigateur afin d&apos;améliorer
            votre expérience et de nous permettre de réaliser des études sur le
            volume de trafic et accroître la pertinence de nos publicités en
            ligne. Pour certains d&apos;entre eux votre consentement est
            nécessaire, d&apos;autres sont des cookies techniques obligatoires
            pour naviguer sur nos sites. En voici le détail : Cookies de
          ...
          <p className="font-semibold mt-2 text-[#424242]">
            ...
            <span className="font-normal">
              ...
              afin d&apos;afficher de la publicité personnalisée en fonction de
              votre navigation et de votre profil. Si vous cliquez sur
              &apos;Tout accepter&apos; ci-dessous, vous pourrez modifier vos
              préférences à tout moment en cliquant sur l&apos;icône de cookie
              en bas à gauche de votre écran lorsque vous poursuivrez votre
              navigation. Si vous ne cliquez pas sur &apos;Tout accepter&apos;,
              seuls les cookies strictement nécessaires au fonctionnement du
              site seront utilisés, même si cette fenêtre disparaît. Vous pouvez
              vous y opposer et les supprimer en utilisant les paramètres de
              votre navigateur, cependant votre expérience utilisateur risque
              d&apos;être dégradée et certains de nos services inaccessibles.
            </span>
          </p>
          ...
          <p className=" text-[#424242]">
            ...
            identifier les pages les plus / moins visitées et d&apos;évaluer
            comment les visiteurs naviguent sur le site Web. Toutes les
            informations collectées par ces cookies sont agrégées et donc
            anonymisées. Si vous n&apos;acceptez pas ces cookies, nous ne serons
            pas informés de votre visite sur notre site.Cookies de suivi
            d&apos;audience :
          </p>
          ...
          <p className=" text-[#424242]">
            ...
            publicités pertinentes sur d&apos;autres sites Web. Ils ne stockent
            pas directement des données personnelles, mais sont basés sur
            l&apos;identification unique de votre navigateur et de votre
            appareil Internet. Si vous n&apos;autorisez pas ces cookies, votre
          ...
          <p className=" text-[#424242]">
            ...
            compter de leur dépôt sur votre navigateur. A l&apos;expiration de
            ce délai, votre consentement sera à nouveau requis.
          </p>
          <p className=" text-[#424242]">
          ...
          <p className=" text-[#424242] my-2">
            ...
            mobile associée ou de l&apos;un des éléments qu&apos;ils contiennent
          ...
          <p className=" text-[#424242]">
            ...
            de l&apos;accès au site www.parallelisme.fr et/ou à
            l&apos;application mobile associée, et résultant soit de
          ...
          <p className=" text-[#424242] my-2">
            A l&apos;occasion de l&apos;utilisation du site www.parallelisme.fr
            et/ou de l&apos;application mobile associée, peuvent êtres
            recueillies : l&apos;URL des liens par l&apos;intermédiaire desquels
            l&apos;utilisateur a accédé au site www.parallelisme.fr et
          ...
          <p className=" text-[#424242] my-2">
            ...
            précisé à l&apos;utilisateur l&apos;obligation ou non de fournir ces
            informations.
          </p>
          <p className=" text-[#424242] my-2">
            ...
            et aux libertés, tout utilisateur dispose d&apos;un droit
            ...
            laquelle la réponse doit être envoyée au 118 ROUTE DE VERSAILLES -
            91160 CHAMPLAN.
          </p>
          <p className=" text-[#424242] my-2">
            ...
            Seule l&apos;hypothèse du rachat de PARALLELISME 91 et de ses droits
            ...
            l&apos;utilisateur du site www.parallelisme.fr et/ou de
          ...
          <p className=" text-[#424242] my-2">
            ...
            des personnes physiques auxquelles elles s&apos;appliquent »
